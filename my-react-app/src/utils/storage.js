...
const STORAGE_KEYS = {
  CUSTOMERS: 'rajwindows_customers',
  PRODUCTS: 'rajwindows_products',
  QUOTATIONS: 'rajwindows_quotations',
  INVOICES: 'rajwindows_invoices',
  ORDERS: 'rajwindows_orders',
  PAYMENTS: 'rajwindows_payments',
  SETTINGS: 'rajwindows_settings'
};
